      ...
      <>
        ...
        <div className="p-4 md:p-8">
          ...
          <div className="my-4">
            ...
            <p>Feedback: 🌟🌟🌟🌟🌟</p>
            <p>
              "Had an amazing experience working with the team! Looking forward
          ...
          <div className="my-4">
            ...
            <p>Feedback: 🌟🌟🌟🌟</p>
            <p>
              "Great collaboration! Everything was seamless and well-organized."
            </p>
          </div>
          <div className="my-4">
          ...
          <p className="text-center my-4">
            We strive to create the best experience for our influencers. Please
            share your thoughts on your recent collaboration with us. Your
            feedback helps us improve and grow together! 🌟
          </p>
          <form className="my-4">
